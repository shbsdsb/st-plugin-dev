...
function Layout(props) {
  ...
  const sidebar = (side, w, collapsed, setCollapsed) => {
    if (side === "left") {
      ...
      return import_react.default.createElement(
        ...
        import_react.default.createElement(
          "div",
          { "data-slot": "sidebar-left", style: { width: w, flexShrink: 0, overflow: "auto", display: "flex", flexDirection: "column", borderRight: "1px solid var(--ui-border, #ccc)" } },
          import_react.default.createElement(
            "div",
    ...
    return import_react.default.createElement(
      ...
      import_react.default.createElement(
        "div",
        { "data-slot": "sidebar-right", style: { width: w, flexShrink: 0, overflow: "auto", borderLeft: "1px solid var(--ui-border, #ccc)" } },
        import_react.default.createElement(
          "div",
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      { "data-slot": "nav", style: { height: NAV_H, display: "flex", alignItems: "center", padding: "0 8px", flexShrink: 0, borderBottom: "1px solid var(--ui-border, #ccc)" } },
      navChildren
    ),
    desktopBody,
    overlayVisible && import_react.default.createElement(
      "div",
      {
        ...
        style: { position: "fixed", left: overlayPos.x, top: overlayPos.y, width: 240, height: 160, border: "1px solid var(--ui-border-strong, #999)", borderRadius: 6, cursor: "move", zIndex: 1e3, display: "flex", flexDirection: "column" }
      },
      import_react.default.createElement(
        "div",
