...
function Layout(props) {
  ...
  const [overlayVisible, setOverlayVisible] = import_react.default.useState(true);
  ...
  const btn = (label, onClick) => import_react.default.createElement("button", { onClick, style: { border: "none", background: "none", cursor: "pointer", fontSize: 12, padding: 2 } }, label);
  const sidebar = (side, w, collapsed, setCollapsed) => collapsed ? import_react.default.createElement(
    "div",
    { style: { width: 24, display: "flex", alignItems: "flex-start", justifyContent: "center", paddingTop: 8 } },
    ...
    side === "left" && import_react.default.createElement(
      "div",
      { style: { width: w, overflow: "auto", display: "flex", flexDirection: "column", borderRight: "1px solid #ccc" } },
      import_react.default.createElement(
        "div",
    ...
    side === "right" && import_react.default.createElement(
      "div",
      { style: { width: w, overflow: "auto", borderLeft: "1px solid #ccc" } },
      import_react.default.createElement(
        "div",
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "div",
      { style: { height: NAV_H, display: "flex", alignItems: "center", padding: "0 8px", flexShrink: 0, borderBottom: "1px solid #ccc" } },
