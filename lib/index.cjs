...
function Layout(props) {
  ...
  const btn = (icon, onClick, title) => import_react.default.createElement(
    "button",
  ...
  const sidebar = (side, w, collapsed, setCollapsed) => {
    if (side === "left") {
      if (collapsed) {
        return import_react.default.createElement(
          "div",
          { "data-slot": "sidebar-left", style: { width: COLLAPSED_LEFT_W, flexShrink: 0, display: "flex", justifyContent: "center", paddingTop: 8 } },
